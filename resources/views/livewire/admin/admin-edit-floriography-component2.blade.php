            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                Edit Floriography Details
                            </div>
                            <div class="col-md-6">
                                <a href="{{route('admin.floriography')}}" class="btn btn-success pull-right">All Floriographies</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="updateFloriography2">
