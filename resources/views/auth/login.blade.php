							...
							<div class="login-form form-item form-stl">
								...
								<form name="frm-login" method="POST" action="{{route('login')}}">
									...
									<fieldset class="wrap-input">
                                        ...
                                        {{-- <a class="link-function left-position" href="{{route('guest.checkout')}}" title="Guest Checkout?">Guest Checkout?</a> --}}

									</fieldset>
									<input type="submit" class="btn btn-submit" value="Login" name="submit">
                                    <a href="{{ route('register') }}" class="btn btn-success pull-right">Register an account</a>
								</form>
							</div>
						</div>
