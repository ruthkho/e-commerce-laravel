                                    ...
                                    @auth
                                        @if(Auth::user()->utype === 'ADM')
                                            <li class="menu-item menu-item-has-children parent" >
                                                <a title="My Account" href="{{ route('admin.profile') }}">My Account ({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                                <ul class="submenu curency" >
                                                    ...
                                                    <li class="menu-item">
                                                        <a title="Occasions" href="{{route('admin.occasions')}}"> Occasions </a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a title="Flowers" href="{{route('admin.flowers')}}"> Flowers </a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a title="Manage Home Slider" href="{{route('admin.homeslider')}}">Home Slider</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a title="Settings" href="{{route('admin.settings')}}">Website Contact Details</a>
                                                    </li>
                                                    {{-- <li class="menu-item">
                                                        <a title="Manage Home Categories" href="{{route('admin.homecategories')}}">Manage Home Categories</a>
                                                    </li> --}}
                                                    {{-- <li class="menu-item">
                                                        <a title="Manage Home Occasions" href="{{route('admin.homeoccasions')}}">Manage Home Occasions</a>
                                                    </li> --}}
                                                    {{-- <li class="menu-item">
                                                        <a title="Manage Home Flowers" href="{{route('admin.homeflowers')}}">Manage Home Flowers</a>
                                                    </li> --}}
                                                    <li class="menu-item">
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
                                ...
                                <li class="menu-item">
                                    <a title="Products" href="{{route('admin.floriography')}}">Floriographies</a>
                                </li>
                                <li class="menu-item">
                                    <a title="Products" href="{{route('admin.viewusers')}}"> Customer List </a>
                                </li>
                                <li class="menu-item">
                                    <a title="Contact Messages" href="{{route('admin.contact')}}">Enquiry Messages</a>
                                </li>
							</ul>
						</div>
					</div>
