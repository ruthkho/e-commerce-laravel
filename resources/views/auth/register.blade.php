							...
							<div class="register-form form-item ">
								...
								<form class="form-stl" action="{{route('register')}}" name="frm-login" method="POST" >
									...
									<fieldset class="wrap-input item-width-in-half left-item ">
										...
										<input type="password" id="frm-reg-pass" name="password" placeholder="At least 8 characters" required autocomplete="new-password">
									</fieldset>
                                    ...
                                    <a href="{{ route('login') }}" class="btn btn-success pull-right">Already have an account</a>
								</form>
							</div>
						</div>
