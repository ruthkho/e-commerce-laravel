<main id="main" class="main-site">
    ...
    <style>
        .summary-item .row-in-form input[type=password], .summary-item .row-in-form input[type=tel] {
        font-size: 13px;
        line-height: 19px;
                ...
                <div class="row">
                        ...
                        <div class="wrap-address-billing">
                            ...
                            <div class="billing-address">
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="fname" value="" placeholder="What do you prefer us to call you?" wire:model="firstname">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="email" name="email" value="{{auth()->user()->email}}" placeholder="Email Adress" wire:model="email">
                                    @error('email') <span class="text-danger">{{$message}}</span> @enderror
                                </p>

                                <p class="row-in-form">
                                    <label for="phone">Contact Number<span>*</span></label>
                                    <input type="number" name="phone" value="" placeholder="In case our delivery guy cannot find your location." wire:model="mobile">
                                ...
                                <p class="row-in-form">
                                    ...
                                    <input type="text" name="country" value="" placeholder="Malaysia" wire:model="country">
                                    @error('country') <span class="text-danger">{{$message}}</span> @enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="city">City<span>*</span></label>
                                    <input type="text" name="city" value="" placeholder="Which city are you in?" wire:model="city">
                                    @error('city') <span class="text-danger">{{$message}}</span> @enderror
                                </p>
                                <p class="row-in-form">
                                    <label for="city">State<span>*</span></label>
                                    <input type="text" name="state" value="" placeholder="State" wire:model="state">
                        ...
                        <div class="col-md-12">
                            <div class="wrap-address-billing">
                                ...
                                <div class="billing-address">
                                    ...
                                    <p class="row-in-form">
                                        <label for="country">Country<span>*</span></label>
                                        <input type="text" name="country" value="" placeholder="Malaysia" wire:model="s_country">
                                    ...
                                    <p class="row-in-form">
                                        <label for="city">State<span>*</span></label>
                                        <input type="text" name="state" value="" placeholder="State" wire:model="s_state">
                    ...
                    <div class="summary">
                        <div class="order-summary">
                            <h4 class="title-box">Add Message</h4>
                            ...
                            font-size: 16px;
                            resize: none;" type="text" name="message" value="" placeholder="Leave a message. Ex: Wrapping paper color - pink + white." wire:model="message">
                        </div>
                    </div>
                    ...
                    <div class="summary-item payment-method">
                        ...
                        <div class="choose-payment-methods">
                            ...
                            <label class="payment-method">
                                ...
                                <span class="payment-desc">Pay with your card.</span>
                            </label>
                            {{-- <label class="payment-method">
                                <input name="payment-method" id="payment-method-paypal" value="paypal" type="radio" wire:model="paymentmode">
                                <span>Paypal</span>
                                <span class="payment-desc">Use Paypal.</span>
                            </label> --}}
                        ...
                        @endif
                        <button type="submit" class="btn btn-medium" >Confirm Order</button>
